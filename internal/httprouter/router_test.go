...
func TestRouter(t *testing.T) {
	...
	routed := false
	router.Handle(http.MethodGet, "/user/:name", func(w http.ResponseWriter, r *http.Request, ps Params) error {
		routed = true
...
func TestRouterAPI(t *testing.T) {
	...
	router.HandlerFunc(http.MethodGet, "/HandlerFunc", func(w http.ResponseWriter, r *http.Request) error {
		handlerFunc = true
		return nil
	})
...
func TestRouterInvalidInput(t *testing.T) {
	...
	handle := func(_ http.ResponseWriter, _ *http.Request, _ Params) error { return nil }
...
func TestRouterOPTIONS(t *testing.T) {
	handlerFunc := func(_ http.ResponseWriter, _ *http.Request, _ Params) (err error) { return }
	...
	router.GlobalOPTIONS = caddyhttp.HandlerFunc(func(w http.ResponseWriter, r *http.Request) error {
...
func TestRouterNotAllowed(t *testing.T) {
	...
	router.MethodNotAllowed = caddyhttp.HandlerFunc(func(w http.ResponseWriter, req *http.Request) error {
...
func TestRouterNotFound(t *testing.T) {
	...
	var notFound bool
	router.NotFound = caddyhttp.HandlerFunc(func(rw http.ResponseWriter, r *http.Request) error {
...
func TestRouterPanicHandler(t *testing.T) {
	...
	router.Handle(http.MethodPut, "/user/:name", func(_ http.ResponseWriter, _ *http.Request, _ Params) error {
		panic("oops!")
	})
...
func TestRouterParamsFromContext(t *testing.T) {
	...
	wantParams := Params{Param{"name", "gopher"}}
	handlerFunc := func(_ http.ResponseWriter, req *http.Request) error {
	...
	handlerFuncNil := func(_ http.ResponseWriter, req *http.Request) error {
		// get params from request context
		params := ParamsFromContext(req.Context())
...
func TestRouterMatchedRoutePath(t *testing.T) {
	route1 := "/user/:name"
	routed1 := false
	handle1 := func(_ http.ResponseWriter, req *http.Request, ps Params) error {
	...
	routed2 := false
	handle2 := func(_ http.ResponseWriter, req *http.Request, ps Params) error {
		route := ps.MatchedRoutePath()
		if route != route2 {
	...
	route3 := "/"
	routed3 := false
	handle3 := func(_ http.ResponseWriter, req *http.Request, ps Params) error {
		route := ps.MatchedRoutePath()
		if route != route3 {
